...
class _MeetingState extends State<Meeting> {
  ...
  _joinMeeting() async {
    ...
    var options = JitsiMeetingOptions()
      ...
      ..userDisplayName =
          FirebaseAuth.instance.currentUser.displayName ?? nameText.text
      ..userEmail = FirebaseAuth.instance.currentUser.email ?? emailText.text
